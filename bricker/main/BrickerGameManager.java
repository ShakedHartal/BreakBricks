...
public class BrickerGameManager extends GameManager {
    ...
    private static final int FLORE_SPACE = 30;
    private static final int MAX_CAMERA_COLLISION = 4;
    ...
    private static final String BALL_SOUND = "assets/blop.wav";
    ...
    public void initializeGame(ImageReader imageReader,
        ...
        Renderable heartImage = imageReader.readImage(
                HEART_IMAGE, true);
        life = new Life(new Vector2(BORDER_WIDTH, windowDimensions.y()-(BORDER_WIDTH*2)),
    ...
    public void update(float deltaTime) {
        ...
        checkForGameEnd();
        if(ball.getCollisionCounter() - cameraCollisionCounter > MAX_CAMERA_COLLISION){
            setCamera(null);
        }
    }
    ...
    private void createUserPaddle(Renderable paddleImage, UserInputListener inputListener,
        ...
        userPaddle.setCenter(
                new Vector2(windowDimensions.x()/2, (int)windowDimensions.y()-FLORE_SPACE));
